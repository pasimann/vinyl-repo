...
public class VinylStoreApiController {
    ...
    @Cacheable(cacheNames = "StoreItem", key = "T(java.util.Objects).hash(#artist, 'searchVinylStoreByArtist')")
    ...
    public @ResponseBody int countVinylItemsByArtist(@RequestParam(value = "artist", required = true) String artist) {
